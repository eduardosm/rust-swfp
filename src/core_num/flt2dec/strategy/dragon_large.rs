...
use super::super::super::bignum::{Big32x540 as Big, Digit32 as Digit};
...
pub(in super::super::super) fn format_shortest<'a>(
    ...
    assert!(d.minus > 0);
    assert!(d.plus > 0);
    assert!(d.mant.checked_add(d.plus.into()).is_some());
    assert!(d.mant.checked_sub(d.minus.into()).is_some());
...
#[cfg(test)]
mod tests {
    use super::super::super::super::bignum::Big32x540 as Big;
